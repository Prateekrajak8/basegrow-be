...
if USE_SQLITE:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("POSTGRES_DB", "basegrow_prod"),
...
ONGAGE_ACCOUNT_CODE = os.getenv("ONGAGE_ACCOUNT_CODE", "")
ONGAGE_USERNAME = os.getenv("ONGAGE_USERNAME", "")
ONGAGE_PASSWORD = os.getenv("ONGAGE_PASSWORD", "")
